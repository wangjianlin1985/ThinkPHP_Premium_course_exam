		       ...
		       text: "课件管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: backURL + getVisitPath("Kejian") + "/teacherAdd"
			    	   	},
			    		{
			    	   		text: "我上传的课件",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: backURL + getVisitPath("Kejian") + "/teacherBackList"
			    	    }
			    	   ]
			},{
		       text: "学习视频管理",
		       ...
		       text: "家庭作业管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: backURL + getVisitPath("Homework") + "/teacherAdd"
			    	   	},
			    		{
			    	   		text: "我布置的作业管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: backURL + getVisitPath("Homework") + "/teacherBackList"
			    	    }
			    	   ]
			},{
			       text: "系统管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-edit",
			    		    url: backURL + getVisitPath("Teacher") + "/modifyView"
			    	   	}
			    	   ]
			}],
