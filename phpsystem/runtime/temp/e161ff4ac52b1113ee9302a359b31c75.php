...
<div class="container">
	<ul class="breadcrumb">
  		<li><a href="__PUBLIC__/index.php">首页</a></li>
  		<li><a href="<?php echo url('Kejian/frontlist'); ?>">课件信息</a></li>
  		<li class="active">详情查看</li>
	</ul>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">课件id:</div>
		<div class="col-md-10 col-xs-6"><?php echo $kejian['kejianId']; ?></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">课件标题:</div>
		<div class="col-md-10 col-xs-6"><?php echo $kejian['title']; ?></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">课件文件:</div>
		<div class="col-md-10 col-xs-6"><a href="__PUBLIC__/<?php echo $kejian['kejianFile']; ?>" target="_blank"><?php echo $kejian['kejianFile']; ?></a></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">课件描述:</div>
		<div class="col-md-10 col-xs-6"><?php echo $kejian['kejianDesc']; ?></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">发布老师:</div>
		<div class="col-md-10 col-xs-6"><?php echo $kejian['teacherObjF']['teacherName']; ?></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">发布时间:</div>
		<div class="col-md-10 col-xs-6"><?php echo $kejian['addTime']; ?></div>
	</div>
	<div class="row bottom15">
