<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:91:"C:\xampp\htdocs\phpsystem\public/../application/back\view\homework\homework_teacherAdd.html";i:1550669416;}*/ ?>
...
<div id="homeworkAddDiv">
	<form id="homeworkAddForm" enctype="multipart/form-data"  method="post">
		...
		<div class="operation">
			<a id="homeworkAddButton" class="easyui-linkbutton">布置作业</a>
			<a id="homeworkClearButton" class="easyui-linkbutton">重填</a>
		</div> 
	</form>
</div>
<script> var backURL = "__PUBLIC__/index.php/back/";</script>
<script src="__PUBLIC__/backjs/homework/homework_teacher_add.js"></script>
