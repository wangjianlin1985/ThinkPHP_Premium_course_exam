...
<script>
				    				...
				    				<table class="table table-condensed table-hover">
				    					...
				    					if(is_array($questionRs) || $questionRs instanceof \think\Collection): $i = 0; $__LIST__ = $questionRs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$question): $mod = ($i % 2 );++$i;?>
 										<tr>
 											...
 											<td><?php echo $question['userObjF']['name']; ?></td>
 											...
 											<td>
 												...
 												<a href="#" onclick="questionDelete('<?php echo $question['questionId']; ?>');" style="display:none;"><i class="fa fa-trash-o fa-fw"></i>删除</a>
 											</td> 
 										</tr>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="questionQueryForm" id="questionQueryForm" action="<?php echo url('Question/frontlist'); ?>" class="mar_t15" method="post">
			<div class="form-group">
