<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"C:\xampp\htdocs\phpsystem\public/../application/back\view\teacher\teacher_query.html";i:1550587159;}*/ ?>
	...
	<form id="teacherEditForm" enctype="multipart/form-data"  method="post">
		<div>
			...
			<span class="inputControl">
				<input class="textbox" type="text" id="teacher_teacherNo_edit" name="teacher_teacherNo" style="width:200px" />
			</span>
		</div>
		<div>
...
<script type="text/javascript" src="__PUBLIC__/backjs/teacher/teacher_manage.js"></script>
