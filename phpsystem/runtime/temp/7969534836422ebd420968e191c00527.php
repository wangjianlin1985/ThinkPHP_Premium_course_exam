<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:85:"C:\xampp\htdocs\phpsystem\public/../application/front\view\score\score_frontshow.html";i:1550587162;s:77:"C:\xampp\htdocs\phpsystem\public/../application/front\view\common\header.html";i:1550653104;s:77:"C:\xampp\htdocs\phpsystem\public/../application/front\view\common\footer.html";i:1538061378;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<div class="container">
	<ul class="breadcrumb">
  		<li><a href="__PUBLIC__/index.php">首页</a></li>
  		<li><a href="<?php echo url('Score/frontlist'); ?>">学生成绩信息</a></li>
  		<li class="active">详情查看</li>
	</ul>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">成绩id:</div>
		<div class="col-md-10 col-xs-6"><?php echo $score['scoreId']; ?></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">考试学生:</div>
		<div class="col-md-10 col-xs-6"><?php echo $score['studentObjF']['name']; ?></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">测试试卷:</div>
		<div class="col-md-10 col-xs-6"><?php echo $score['paperObjF']['paperName']; ?></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">考试成绩:</div>
		<div class="col-md-10 col-xs-6"><?php echo $score['chengji']; ?></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">考试时间:</div>
		<div class="col-md-10 col-xs-6"><?php echo $score['examTime']; ?></div>
	</div>
	<div class="row bottom15">
