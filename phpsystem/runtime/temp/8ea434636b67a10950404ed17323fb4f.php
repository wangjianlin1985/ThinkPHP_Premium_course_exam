...
<div class="container">
	<ul class="breadcrumb">
  		<li><a href="__PUBLIC__/index.php">首页</a></li>
  		<li><a href="<?php echo url('Homework/frontlist'); ?>">家庭作业信息</a></li>
  		<li class="active">详情查看</li>
	</ul>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">作业id:</div>
		<div class="col-md-10 col-xs-6"><?php echo $homework['homeworkId']; ?></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">作业任务:</div>
		<div class="col-md-10 col-xs-6"><?php echo $homework['taskTitle']; ?></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">作业要求:</div>
		<div class="col-md-10 col-xs-6"><?php echo $homework['taskContent']; ?></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">布置的老师:</div>
		<div class="col-md-10 col-xs-6"><?php echo $homework['teacherObjF']['teacherName']; ?></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">作业日期:</div>
		<div class="col-md-10 col-xs-6"><?php echo $homework['homeworkDate']; ?></div>
	</div>
	<div class="row bottom15">
