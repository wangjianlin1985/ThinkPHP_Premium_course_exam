...
<div class="container">
	<ul class="breadcrumb">
  		<li><a href="__PUBLIC__/index.php">首页</a></li>
  		<li><a href="<?php echo url('Video/frontlist'); ?>">学习视频信息</a></li>
  		<li class="active">详情查看</li>
	</ul>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">视频id:</div>
		<div class="col-md-10 col-xs-6"><?php echo $video['videoId']; ?></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">视频标题:</div>
		<div class="col-md-10 col-xs-6"><?php echo $video['title']; ?></div>
	</div>
	<div class="row bottom15">
		<div class="col-md-2 col-xs-4 text-right bold">视频介绍:</div>
		<div class="col-md-10 col-xs-6"><?php echo $video['videoDesc']; ?></div>
	</div>
	<div class="row bottom15">
		<div class="col-md-2 col-xs-4 text-right bold">发布老师:</div>
		<div class="col-md-10 col-xs-6"><?php echo $video['teacherObjF']['teacherName']; ?></div>
	</div>
	<div class="row bottom15">
		<div class="col-md-2 col-xs-4 text-right bold">发布时间:</div>
		<div class="col-md-10 col-xs-6"><?php echo $video['videoTime']; ?></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">视频播放:</div>
		<div class="col-md-10 col-xs-6">
			<video class="video1" src="__PUBLIC__/<?php echo $video['videoFile']; ?>" poster="/templets/wzhan/images/1470963124.jpg" controls="" autoplay="autoplay" style="width:100%; height:auto;"></video>
