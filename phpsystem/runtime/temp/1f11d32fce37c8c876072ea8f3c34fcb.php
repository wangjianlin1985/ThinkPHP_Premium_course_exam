...
<div class="container">
	<ul class="breadcrumb">
  		<li><a href="__PUBLIC__/index.php">首页</a></li>
  		<li><a href="<?php echo url('Subject/frontlist'); ?>">题库题目信息</a></li>
  		<li class="active">详情查看</li>
	</ul>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">题目id:</div>
		<div class="col-md-10 col-xs-6"><?php echo $subject['subjectId']; ?></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">题目标题:</div>
		<div class="col-md-10 col-xs-6"><?php echo $subject['title']; ?></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">A:</div>
		<div class="col-md-10 col-xs-6"><?php echo $subject['a_option']; ?></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">B:</div>
		<div class="col-md-10 col-xs-6"><?php echo $subject['b_option']; ?></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">C:</div>
		<div class="col-md-10 col-xs-6"><?php echo $subject['c_option']; ?></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">D:</div>
		<div class="col-md-10 col-xs-6"><?php echo $subject['d_option']; ?></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">正确答案:</div>
		<div class="col-md-10 col-xs-6"><?php echo $subject['rightOption']; ?></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">得分:</div>
		<div class="col-md-10 col-xs-6"><?php echo $subject['score']; ?></div>
	</div>
	<div class="row bottom15">
