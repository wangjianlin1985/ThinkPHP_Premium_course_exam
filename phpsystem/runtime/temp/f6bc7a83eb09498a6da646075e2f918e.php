...
<script>
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>成绩id</td><td>考试学生</td><td>测试试卷</td><td>考试成绩</td><td>考试时间</td><td>操作</td></tr>
				    					<?php
				    						/*计算起始序号*/
				    					...
				    					if(is_array($scoreRs) || $scoreRs instanceof \think\Collection): $i = 0; $__LIST__ = $scoreRs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$score): $mod = ($i % 2 );++$i;?>
 										<tr>
 											...
 											<td><?php echo $score['studentObjF']['name']; ?></td>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="scoreQueryForm" id="scoreQueryForm" action="<?php echo url('Score/frontlist'); ?>" class="mar_t15" method="post">
            <div class="form-group">
