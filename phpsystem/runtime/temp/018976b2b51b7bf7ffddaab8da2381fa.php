<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"C:\xampp\htdocs\phpsystem\public/../application/back\view\index\teacherIndex.html";i:1550677924;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <title>信息管理系统</title>
...
<div data-options="region:'north',title:'header',split:true,noheader:true" style="height:60px;background-color:#c0a16b;border:0px;">
    <div class="logo">php精品课程网后台管理</div>
    <div class="logout">您好老师，<?php echo \think\Session::get('username'); ?>| <a href="<?php echo url('Login/logout'); ?>">退出</a></div>
</div>
...
<script type="text/javascript" src="__PUBLIC__/backjs/teacherMain.js"></script>
