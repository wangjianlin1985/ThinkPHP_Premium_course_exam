<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:99:"C:\xampp\htdocs\phpsystem\public/../application/front\view\paperSubject\paperSubject_frontshow.html";i:1550587161;s:77:"C:\xampp\htdocs\phpsystem\public/../application/front\view\common\header.html";i:1550642389;s:77:"C:\xampp\htdocs\phpsystem\public/../application/front\view\common\footer.html";i:1538061378;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<div class="container">
	<ul class="breadcrumb">
  		<li><a href="__PUBLIC__/index.php">首页</a></li>
  		<li><a href="<?php echo url('PaperSubject/frontlist'); ?>">试卷题目信息</a></li>
  		<li class="active">详情查看</li>
	</ul>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">试卷题目id:</div>
		<div class="col-md-10 col-xs-6"><?php echo $paperSubject['psId']; ?></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">测试试卷:</div>
		<div class="col-md-10 col-xs-6"><?php echo $paperSubject['paperObjF']['paperName']; ?></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">题库题目:</div>
		<div class="col-md-10 col-xs-6"><?php echo $paperSubject['subjectObjF']['title']; ?></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">添加时间:</div>
		<div class="col-md-10 col-xs-6"><?php echo $paperSubject['addTime']; ?></div>
	</div>
	<div class="row bottom15">
