...
<div class="container">
	<ul class="breadcrumb">
  		<li><a href="__PUBLIC__/index.php">首页</a></li>
  		<li><a href="<?php echo url('Teacher/frontlist'); ?>">教师信息</a></li>
  		<li class="active">详情查看</li>
	</ul>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">教师工号:</div>
		<div class="col-md-10 col-xs-6"><?php echo $teacher['teacherNo']; ?></div>
	</div>

	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">教师姓名:</div>
		<div class="col-md-10 col-xs-6"><?php echo $teacher['teacherName']; ?></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">教师性别:</div>
		<div class="col-md-10 col-xs-6"><?php echo $teacher['teacherSex']; ?></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">教师年龄:</div>
		<div class="col-md-10 col-xs-6"><?php echo $teacher['teacherAge']; ?></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">教师照片:</div>
		<div class="col-md-10 col-xs-6"><img class="img-responsive" src="__PUBLIC__/<?php echo $teacher['teacherPhoto']; ?>"  border="0px"/></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">入职日期:</div>
		<div class="col-md-10 col-xs-6"><?php echo $teacher['comeDate']; ?></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">教师介绍:</div>
		<div class="col-md-10 col-xs-6"><?php echo $teacher['teacherDesc']; ?></div>
	</div>
	<div class="row bottom15">
